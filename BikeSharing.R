...
bike_share_test <- read.csv(
  "https://raw.githubusercontent.com/sabinychungath/HarvardX-DataScience/master/BikeSharing/test.csv",
  header = TRUE)
bike_share_train <- read.csv(
  "https://raw.githubusercontent.com/sabinychungath/HarvardX-DataScience/master/BikeSharing/train.csv",
  header = TRUE)
...
corrplot(train_cor, method = 'color', addCoef.col="green")
